...
> **Source** : intl-ai-corpus · [Voir l'annonce](https://builtin.com/job/software-engineer-ai-compiler/8522368)
> **Job ID** : `intl-ai-corpus-1562` (upstream ref `8522368`)
...
| **Focus entreprise** | AI accelerator and compiler infrastructure |
...
- Enable efficient mapping of high-level ML models to hardware by working with model frameworks and graph representations
...
| **Outils** | Code generation, Compiler design, Glow, Hardware-software co-design, IR transformations, Kernel optimization, LLVM, MLIR, Performance profiling, TVM, XLA |
...
- **LLM extraction** : 2026-02-27T12:18:06.722856
