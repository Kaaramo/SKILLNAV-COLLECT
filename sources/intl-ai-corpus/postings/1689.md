...
> **Source** : intl-ai-corpus · [Voir l'annonce](https://builtin.com/job/ai-forward-deploy-engineer/8577082)
> **Job ID** : `intl-ai-corpus-1689` (upstream ref `8577082`)
...
| **Entreprise** | ArangoDB |
| **Stage entreprise** | — |
| **Focus entreprise** | Multi-model database platform for AI applications |
...
This is a Forward Deploy Engineer who builds and deploys
production AI solutions including RAG pipelines, agent
systems, and fine-tuned models. The role involves hands-on
implementation of retrieval-augmented generation, model
optimization with LoRA/PEFT, and inference serving - all
core AI/ML engineering work.
...
- Partner with customer stakeholders to identify high-value AI use cases and define delivery plans
- Build end-to-end prototypes including data connectors, RAG pipelines, prompts, tools, and UIs/APIs
- Implement retrieval-augmented generation with chunking, embeddings, ranking, caching, and tool orchestration
- Productionize AI solutions with CI/CD, infrastructure-as-code, security, and observability
- Fine-tune and adapt models using LoRA/PEFT, DPO, and distillation; optimize inference with quantization, vLLM, and TensorRT-LLM
- Monitor quality metrics, drift, hallucinations, latency, and costs; set up alerting and dashboards

---

## Use cases

- Secure RAG assistant over millions of documents with hybrid search and guardrails
- High-volume customer support copilot with CRM/ITSM integration and strict response-time SLOs
- Document intake pipeline with PII detection, redaction, and structured extraction
- Fine-tuned classification and routing models to reduce human triage by 40%+
...
| **Frameworks** | Anthropic APIs, DPO, Hugging Face, LangChain, Llama, LlamaIndex, LoRA, OpenAI APIs, PEFT, RAG, function calling |
| **Outils** | Airflow, BigQuery, Docker, FAISS, FastAPI, GitHub Actions, Grafana, Kafka, Kubernetes, MLflow, Next.js, OpenTelemetry, Pinecone, Postgres, Prometheus, Ragas, Ray, React, Snowflake, TensorRT-LLM, Terraform, Weaviate, Weights & Biases, gRPC, pgvector, promptfoo, vLLM |
...
- **LLM extraction** : 2026-02-27T12:35:30.272582
